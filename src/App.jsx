...
function App() {
  ...
  const emit = async (code) => { if (!window.AudioContext) return; const context = new AudioContext(); await context.resume(); for (const digit of code) await playTone(context, TONES[Number(digit)]); context.close() }
...
function AirShareFooter() {
  return <footer className="airshare-footer"><div className="footer-brand"><span className="brand-mark" /> <strong>Air Share</strong><small>Fast, private peer-to-peer sharing.</small></div><a className="feedback-link" href="mailto:vikram.2872006@gmail.com?subject=Air%20Share%20feedback">Feedback</a><div className="footer-links"><a href="https://www.instagram.com/vikrm_bhardwaj?igsh=OWh4ZHprbW5rNTZv" target="_blank" rel="noreferrer">Instagram</a><a href="https://www.facebook.com/share/196jZuggxg/" target="_blank" rel="noreferrer">Facebook</a><a href="https://github.com/vikrambhardwaj-28/flow-drop" target="_blank" rel="noreferrer">GitHub</a><a href="mailto:vikram.2872006@gmail.com">Email</a></div><div className="footer-credit">By Vikram Bhardwaj</div></footer>
}
